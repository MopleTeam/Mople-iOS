...
final class DateSelectViewController: BaseViewController {
    ...
    init(selectedDate: DateComponents?,
        ...
        self.selectedDate = selectedDate ?? DateManager.todayComponents
...
extension DateSelectViewController: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int,
        ...
        case 2: label.text = "\(dates[row])" + " " + L10n.Date.Label.day
        default: break
        }
