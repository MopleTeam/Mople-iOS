...
final class DefaultAlertViewController: UIViewController {
    ...
    @objc private func backgroundTapped(_ gesture: UITapGestureRecognizer) {
        ...
        if !mainStackView.frame.contains(location) {
    ...
    private func setLayout() {
        self.view.backgroundColor = .appBlack.withAlphaComponent(0.6)
...
extension DefaultAlertViewController: UIGestureRecognizerDelegate {
    func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        // mainStackView 내부를 터치한 경우 제스처를 받지 않음
