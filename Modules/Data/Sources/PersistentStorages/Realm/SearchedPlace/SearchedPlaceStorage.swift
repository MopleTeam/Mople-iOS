...
public protocol SearchedPlaceStorage {
    func fetchPlace()
...
public final class DefaultSearchedPlaceStorage: SearchedPlaceStorage {
    ...
    public func readPlaces() -> [PlaceInfo] {
        return self.cachedPlaces
    }

    public func addPlace(_ place: PlaceInfo) {
        deleteIfExists(place)
        addEntity(.init(place))
        fetchPlace()
    }

    public func deletePlace(_ place: PlaceInfo) {
