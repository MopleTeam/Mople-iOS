...
public final class DefaultReviewRepo: BaseRepositories, ReviewRepo {
    public func fetchReviewPage(meetId: Int,
    ...
    public func fetchReviewDetail(id: Int, isOldPlan: Bool) async throws -> Review {
