...
public final class DefaultCalendarRepo: BaseRepositories, CalendarRepo {
    public func fetchAllDates() async throws -> [Date] {
    ...
    public func fetchHolidays(for year: Int) async throws -> [Holiday] {
    ...
    public func fetchMonthlyPost(month: String) async throws -> [MonthlyPost] {
