...
public final class DefaultPlanRepo: BaseRepositories, PlanRepo {
    ...
    public func fetchPlanDetail(planId: Int) async throws -> Plan {
    ...
    public func fetchPlanPage(meetId: Int, cursor: String?) async throws -> Page<Plan> {
    ...
    public func createPlan(request: PlanRequest) async throws -> Plan {
    ...
    public func participationPlan(planId: Int, isJoin: Bool) async throws {
    ...
    public func editPlan(request: PlanRequest) async throws -> Plan {
        let dto = PlanRequestDTO(request: request)
        let response: PlanResponse = try await networkService.authenticatedRequest {
