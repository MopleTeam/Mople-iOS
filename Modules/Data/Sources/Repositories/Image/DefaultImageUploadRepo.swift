...
public final class DefaultImageUploadRepo: BaseRepositories, ImageUploadRepo {
    public func uploadImage(data: Data, path: ImageUploadPath) async throws -> String {
    ...
    public func uploadReviewImages(id: Int,
