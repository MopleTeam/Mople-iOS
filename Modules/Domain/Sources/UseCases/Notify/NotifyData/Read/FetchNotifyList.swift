...
public protocol FetchNotifyList {
    func execute(cursor: String?) async throws -> Page<Notify>
}

public final class FetchNotifyListUseCase: FetchNotifyList {
    ...
    public func execute(cursor: String?) async throws -> Page<Notify> {
...
// MARK: - Mock
#if DEV
public final class MockFetchNotifyListUseCase: FetchNotifyList {
    public init() {}
