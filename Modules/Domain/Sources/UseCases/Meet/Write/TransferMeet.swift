...
public protocol TransferMeet {
    func execute(meetId: Int, newHostId: Int) async throws
}


// MARK: - Real UseCase (API 연결 후 사용)
public final class TransferMeetUseCase: TransferMeet {
    ...
    public func execute(meetId: Int, newHostId: Int) async throws {
        try await repo.transferMeet(meetId: meetId, newHostId: newHostId)
    }
}

// MARK: - Mock UseCase (API 연결 전 테스트용)
public final class MockTransferMeetUseCase: TransferMeet {
    public init() {}
