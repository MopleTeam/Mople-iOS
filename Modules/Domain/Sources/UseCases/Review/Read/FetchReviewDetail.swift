...
public protocol FetchReviewDetail {
    func execute(id: Int, isOldPlan: Bool) async throws -> Review
}

public final class FetchReviewDetailUseCase: FetchReviewDetail {
    ...
    public func execute(id: Int, isOldPlan: Bool) async throws -> Review {
...
// MARK: - Mock UseCase
#if DEV
public final class MockFetchReviewDetailUseCase: FetchReviewDetail {
    public init() {}
