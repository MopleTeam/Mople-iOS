...
public protocol FetchMentionList {
    func execute(meetId: Int, cursor: String?, keyword: String?) async throws -> Page<MemberInfo>
}

public final class FetchMentionListUseCase: FetchMentionList {

    private let repo: MentionRepo

    public init(repo: MentionRepo) {
        self.repo = repo
    }
...
// MARK: - Mock
#if DEV
public final class MockFetchMentionListUseCase: FetchMentionList {
    public init() {}
    ...
    public func execute(meetId: Int, cursor: String?, keyword: String?) async throws -> Page<MemberInfo> {
