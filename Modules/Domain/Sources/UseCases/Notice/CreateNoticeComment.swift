...
public protocol CreateNoticeComment {
    func execute(noticeId: Int,
                 content: String,
                 mentions: [Int]) async throws -> Comment
}

public final class CreateNoticeCommentUseCase: CreateNoticeComment {
    ...
    public func execute(noticeId: Int,
                        content: String,
                        mentions: [Int]) async throws -> Comment {
        var comment = try await repo.createNoticeComment(noticeId: noticeId,
                                                         content: content,
                                                         mentions: mentions)
...
#if DEV
public final class MockCreateNoticeCommentUseCase: CreateNoticeComment {
    public init() {}
