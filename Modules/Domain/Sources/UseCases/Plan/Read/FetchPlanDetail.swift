...
public protocol FetchPlanDetail {
    func execute(planId: Int) async throws -> Plan
}

public final class FetchPlanDetailUseCase: FetchPlanDetail {
    ...
    public func execute(planId: Int) async throws -> Plan {
...
// MARK: - Mock UseCase
#if DEV
public final class MockFetchPlanDetailUseCase: FetchPlanDetail {
    public init() {}
    public func execute(planId: Int) async throws -> Plan {
