...
public protocol FetchPlanPage {
    func execute(meetId: Int, cursor: String?) async throws -> Page<Plan>
}

public final class FetchPlanPageUsecase: FetchPlanPage {
    ...
    public func execute(meetId: Int, cursor: String?) async throws -> Page<Plan> {
...
// MARK: - Mock UseCase
#if DEV
public final class MockFetchPlanPageUseCase: FetchPlanPage {
    public init() {}
