...
public protocol CreateReplyComment {
...
public final class CreateReplyCommentUseCase: CreateReplyComment {
...
// MARK: - Mock UseCase
#if DEV
public final class MockCreateReplyCommentUseCase: CreateReplyComment {
    public init() {}
